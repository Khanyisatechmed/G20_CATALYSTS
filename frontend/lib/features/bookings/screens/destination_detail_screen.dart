...
class _DestinationDetailScreenState extends State<DestinationDetailScreen> {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          'Discover the hidden heart of South Africa where breathtaking landscapes meet the warmth of Wanders hospitality. In the rural communities, locals share their rich cultural heritage through traditional dance, storytelling, beadwork, pottery, wood carving, and weaving. Experience authentic Wanders philosophy - "I am because we are" - through meaningful cultural exchanges that celebrate our shared humanity.',
          style: TextStyle(
            fontSize: 16,
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            'Wanders is a Nguni Bantu term meaning "humanity" and is often translated as "I am because we are" or "humanity towards others". This philosophy emphasizes the interconnectedness of all people and the belief that a person\'s well-being is tied to the well-being of others.\n\nThrough this cultural experience, you\'ll witness how Wanders principles shape daily life, community interactions, and traditional practices that have been passed down through generations.',
            style: TextStyle(
              fontSize: 15,
              color: Colors.grey[700],
              height: 1.5,
          ...
          Wrap(
            ...
            children: [
              ...
              _buildCulturalTag('Wanders Philosophy'),
            ],
          ),
        ],
      ),
  ...
  void _shareDestination() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Sharing "${widget.destination['title'] ?? 'Wanders Experience'}"...'),
        backgroundColor: Theme.of(context).primaryColor,
      ),
    );
  }
  ...
  void _addToWishlist() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Added "${widget.destination['title'] ?? 'Wanders Experience'}" to your wishlist'),
